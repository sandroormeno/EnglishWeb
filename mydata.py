Myquestions = [
	...
	("Want\nQuerer"), # comentario de respuesta
	("Have\nTener"),
	("I am Rosa Elena\nYo soy Rosa Elena")
	],[
	("want"), # opciones de respuesta
	("have"),
	("am")
	],[
	("audio", "/static/audio/i_am_rosa_elena.mp3"), # audio normal
	("audioSlow", "/static/audio/i__am__rosa__elena.mp3") #a udio lento
...
bigData = [
	...
	("Me llano Rosa"), # respuesta y comentario
	("Encantado de conocerte"),
	("Cómo estás?")
	],[
	("My name is Rosa"), # rspuesta en ingles
	("Nice to meet you"),
	("How are you?")
	],[
